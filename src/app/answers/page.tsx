...
export default function AnswersPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Полная антикоррозийная обработка занимает от 8 до 10 часов в зависимости от типа автомобиля и объема работ. Обработка скрытых полостей — 2-3 часа, днища и порогов — 4-6 часа, комплексная обработка — до 12 часов.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer:
        "Мы предоставляем гарантию на материалы и работы сроком от 1 до 5 лет в зависимости от типа обработки. Гарантия покрывает качество нанесения защитного покрытия и его эффективность при соблюдении рекомендаций по эксплуатации.",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      answer:
        "Мы работаем только с проверенными материалами ведущих производителей: Tectyl, Dinitrol, DUGLA, MasterWax. Все составы имеют сертификаты качества и рекомендованы автопроизводителями.",
    },
    {
      id: 7,
