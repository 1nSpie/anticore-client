  ...
  return (
    <section id={id} className="relative bg-transparent to-gray-100 dark:from-gray-900 dark:to-gray-800 py-16 lg:py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 dark:opacity-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-greenDefault rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="relative max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        >
          <div className="flex justify-center items-center mb-4">
            <ShieldCheckIcon className="w-8 h-8 text-greenDefault mr-3" />
            <h1 className="text-3xl font-bold sm:text-4xl lg:text-5xl text-gray-900 dark:text-white">
              Гарантия
            </h1>
            <ShieldCheckIcon className="w-8 h-8 text-greenDefault ml-3" />
          </div>
          <motion.div 
            className="w-24 h-1 bg-gradient-to-r from-greenDefault to-greenDefaultHover mx-auto mt-4 rounded-full"
            initial={{ scaleX: 0 }}
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          >
            <div className="flex items-center mb-4">
              <ClockIcon className="w-8 h-8 text-greenDefault mr-3" />
        ...
        <div className="xl:hidden">
          <motion.button
            ...
            className="flex justify-between items-center w-full px-6 py-5 text-left text-lg sm:text-xl font-semibold text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-xl hover:bg-teal-50 dark:hover:bg-teal-900/20 focus:outline-none focus:ring-4 focus:ring-greenDefault/30 transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700"
            aria-expanded={isOpen}
            whileHover={{ scale: 1.01 }}
            whileTap={{ scale: 0.99 }}
          >
            <div className="flex items-center">
              <ShieldCheckIcon className="w-6 h-6 text-greenDefault mr-3" />
            ...
            >
              <ChevronDownIcon className="w-6 h-6 text-greenDefault" />
            </motion.div>
          </motion.button>
                ...
                <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="prose dark:prose-invert prose-sm sm:prose-base max-w-none">
                    <p className="text-center mb-6">
                      Что такое{" "}
                      <strong className="text-greenDefault">ГАРАНТИЯ</strong> и для чего это нужно?
                    </p>
                    <p className="mb-4">
                      ...
                      <strong className="text-greenDefault">ГАРАНТИЯ.</strong>
                    </p>
                    <p className="mb-6">
                    ...
                    <h4 className="font-semibold text-greenDefault mb-4">В гарантийное обслуживание входят:</h4>
                    <div className="space-y-3 mb-6">
                      {services.map((service, index) => (
                        ...
                        >
                          <span className="w-2 h-2 bg-greenDefault rounded-full mt-2 flex-shrink-0"></span>
                          <div>
                    ...
                    <div className="bg-gradient-to-r from-teal-50 to-green-50 dark:from-teal-900/20 dark:to-green-900/20 p-4 rounded-lg mb-6">
                      <p className="text-center font-medium">
                        Мы предоставляем гарантию до <strong className="text-greenDefault">5 лет</strong>, и абсолютно неважно,
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 lg:p-12 border border-gray-200 dark:border-gray-700">
            <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-gray-700 dark:text-gray-300 space-y-6 leading-relaxed">
              ...
              <h3 className="text-xl font-bold text-greenDefault text-center mb-8">В гарантийное обслуживание входят:</h3>
                ...
                {services.map((service, index) => (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <span className="w-3 h-3 bg-greenDefault rounded-full mt-2 flex-shrink-0"></span>
                      <div>
              ...
              >
                <p className="text-xl font-medium mb-4">
                  ...
                  <strong className="text-greenDefault text-2xl">5 лет</strong>, и абсолютно неважно,
