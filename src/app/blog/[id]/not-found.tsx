  ...
  return (
    <div className="bg-background1 dark:bg-backgroundDark min-h-screen flex items-center justify-center">
      <div className="text-center px-4">
        <div className="mb-8">
          <h1 className="text-6xl font-bold text-[#007478] dark:text-[#00a2a6] mb-4">
            404
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/blog"
            className="bg-[#007478] hover:bg-[#005a5e] dark:hover:bg-[#009a9f] text-white px-6 py-3 rounded-lg transition-colors font-semibold"
          >
            Вернуться к блогу
          </Link>
          <Link
