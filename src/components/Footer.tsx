          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
              <li className="flex items-start">
                <PhoneIcon className="w-5 h-5 mr-3 mt-0.5 text-greenDefault shrink-0" />
                <Link
              ...
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-3 mt-0.5 text-greenDefault shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span>г. Жуковский, ул. Речной проезд, д. 14</span>
              </li>
              <li className="flex items-start ">
                <svg
                  className="w-5 h-5 mr-3 mt-0.5 text-greenDefault shrink-0"
